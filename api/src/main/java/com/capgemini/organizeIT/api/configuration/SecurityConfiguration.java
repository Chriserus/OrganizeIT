...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                ...
                .antMatchers(HttpMethod.PATCH, "/api/shirt-sizes").hasRole("ADMIN")
                .antMatchers(HttpMethod.GET, "/api/shirt-sizes").permitAll()
                .antMatchers(HttpMethod.GET, "/api/shirt-sizes/active").permitAll()
